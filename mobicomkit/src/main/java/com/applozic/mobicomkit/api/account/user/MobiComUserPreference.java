...
public class MobiComUserPreference {
    ...
    private static String device_contact_sync_key = "device_contact_sync_key";
    ...
    private static String profile_image_file_path ="profile_image_file_path";
...
//    }
    ...
    public boolean isDeviceContactSyncCompleted() {
        return sharedPreferences.getBoolean(device_contact_sync_key, false);
    }

    public void setDeviceContactSyncCompleted(boolean status) {
        setDeviceContactSyncTime(new Date().getTime());
        sharedPreferences.edit().putBoolean(device_contact_sync_key, status).commit();
    }
    ...
    public String getProfilePicFilePath() {
        return sharedPreferences.getString(profile_image_file_path, null);
    }

    public void setProfilePicFilePath(String filePath) {
        sharedPreferences.edit().putString(profile_image_file_path, filePath).commit();
    }
