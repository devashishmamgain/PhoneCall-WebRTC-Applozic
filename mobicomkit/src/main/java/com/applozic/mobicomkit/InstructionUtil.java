...
public class InstructionUtil {
    ...
    public static void showInstruction(final Context context, final String instruction) {
        Intent intentUpdate = new Intent();
        intentUpdate.setAction(BroadcastService.INTENT_ACTIONS.INSTRUCTION.toString());
        intentUpdate.addCategory(Intent.CATEGORY_DEFAULT);
        intentUpdate.putExtra("instruction", instruction);
        BroadcastService.sendBroadcast(context, intentUpdate);
    }

    public static void showToast(Context context, String instruction) {
        Toast toast = Toast.makeText(context, instruction, Toast.LENGTH_LONG);
