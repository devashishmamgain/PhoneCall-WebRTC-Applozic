...
public class ImageCache {
    ...
    public static ImageCache getInstance(
        ...
        final RetainFragmentOld mRetainFragment = findOrCreateRetainFragment(fragmentManager);
    ...
    public static ImageCache getInstance(
            android.app.FragmentManager fragmentManager, float memCacheSizePercent) {
     ...
     * created.
     */
    public static RetainFragmentOld findOrCreateRetainFragment(FragmentManager fm) {
        // Check to see if we have retained the worker fragment.
        RetainFragmentOld mRetainFragment = (RetainFragmentOld) fm.findFragmentByTag(TAG);

        // If not retained (or first time running), we need to create and add it.
        if (mRetainFragment == null) {
            mRetainFragment = new RetainFragmentOld();
     ...
     * changes. It will be used to retain the ImageCache object.
     */
    public static class RetainFragmentOld extends Fragment {
        private Object mObject;

        /**
         * Empty constructor as per the Fragment documentation
         */
        public RetainFragmentOld() {
        }
