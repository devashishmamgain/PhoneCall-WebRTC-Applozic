...
/*  Todo: Will be used for device contacts
    ...
    public boolean hasMobileNumberAndRegistered(){
        return (contactType == ContactType.APPLOZIC.getValue()) && contactNumber != null;
    }

    public boolean isDeviceContactAndRegistered(){
        return (contactType == ContactType.DEVICE_AND_APPLOZIC.getValue()) && contactNumber != null;
    }
